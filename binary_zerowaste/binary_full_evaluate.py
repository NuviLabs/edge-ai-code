...
def run_full_inference(detector_path, binary_path, image_path, save_intermediate=False):
    ...
    for pred in predictions:
        ...
        print(pred, pred.rect.width() * pred.rect.height())
    ...
    if save_intermediate:
        ...
        save_cropped_img.save(image_path.replace('.png', '_crop.png'))

    return binary_classification(cropped_image, binary_path)
...
if __name__ == "__main__":
    ...
    binary_model_path = "/home/kaeun.kim/kaeun-dev/nuvilab/models/export/best_model_yolo_m_tflite4.tflite"

    # image paths
    from glob import glob
    # webps = glob("")
    webps = ["/home/kaeun.kim/kaeun-dev/nuvilab/models/zero_0.75_0.75_0.10800066_1734576580817.png"]
    # webps=["/home/kaeun.kim/kaeun-dev/nuvilab/models/wiryeforest-es_241218_114601_42605_L_A_10164000044A00031_Trayfile.png"]
    # webps = ['/home/kaeun.kim/kaeun-dev/nuvilab/models/sawoo-es_241204_123415_16939_L_A_10064008642000025_Trayfile.png', 
    #          '/home/kaeun.kim/kaeun-dev/nuvilab/models/sawoo-es_241204_123437_16939_L_A_10064008642000025_Trayfile.png',
    #          '/home/kaeun.kim/kaeun-dev/nuvilab/models/sawoo-es_241113_021509_1_L_B_VS-23101004_Trayfile.png',
    #          '/mnt/nas/data/growth_zero/test/binary_zerowaste/0/nuvilabs_241011_124157_32103_D_A_SERIALY_Trayfile.png',
    #          '/home/kaeun.kim/kaeun-dev/nuvilab/models/sawoo-es_241203_131728_17621_L_A_1006400864200000B_Trayfile.png']
    preds = []
    for webp in webps:
        if 'crop' not in webp:
            print(f"==== Processing {webp} ===== ")
            preds.append(run_full_inference(model_path, binary_model_path, webp))
