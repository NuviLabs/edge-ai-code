...
def get_food_area_inside_tray(tray: AIResult, results: List[AIResult]) -> float:
    ...
    food_area = 0.0
    for det in results:
        if det.detection_class == 0 or det.detection_class==5:  # Assuming class 0 is food
...
if __name__ == "__main__":
    ...
    webps = glob("/mnt/nas/data/kaeun/q4/kids/detector_qa/odd_tray/**/*.png", recursive=True)
    ...
    with open(f'/home/kaeun.kim/kaeun-dev/nuvilab/qa/{project_name}/kids_qa_odd_tray.csv', mode='w+', newline='') as full_file:
