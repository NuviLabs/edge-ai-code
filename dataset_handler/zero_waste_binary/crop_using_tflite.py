...
if __name__ == "__main__":
    ...
    binary_model_path = "/home/kaeun.kim/kaeun-dev/nuvilab/models/export/best_model_yolo_m_tflite3.tflite"

    # image paths
    from glob import glob
    # webps = glob("/mnt/nas/data/growth_zero/test/binary_zerowaste/0/*.png")
