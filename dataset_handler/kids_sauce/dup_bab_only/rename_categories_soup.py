import json
data_path = '/mnt/nas/data/growth_zero/kids_sauce_food/merged_coco_raw_250205_empty_dupbab.json'
...
with open('/mnt/nas/data/kaeun/2025q1/kids/dupbab/merged-coco-soup-250205_empty_dupbab.json', 'w+', encoding='utf-8') as f:
