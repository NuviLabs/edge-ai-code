...
import os
from test.run_tflite import run_entire_pipeline
...
model_path = "/home/kaeun.kim/ultralytics/runs/segment/with_dupbab2/weights/best_saved_model/best_float16.tflite"
from tqdm import tqdm
for row_idx, row in enumerate(tqdm(df)):
    ...
    after_path = f'/mnt/nas/data/kaeun/2025q1/kids/dupbab/dupbab_test_images/{dep}/{date}/{after_name}'
    ...
    before_path = f'/mnt/nas/data/kaeun/2025q1/kids/dupbab/dupbab_test_images/{dep}/{date}/{before_name}'
    ...
    cell7 = worksheet.cell(row_idx+1, 6)
    cell7.value = intake 
