...
data_path = '/mnt/nas/data/kaeun/2025q1/kids/sauce_food_soup/no-curry-soup-coco.json'
...
with open('/mnt/nas/data/kaeun/2025q1/kids/sauce_food_soup/no-curry-soup-coco-filtered.json', 'w+', encoding='utf-8') as f:
